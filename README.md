...
| **marx-paper-structure** | 🚧 雏形完成 | 搭结构：先给工整排比式一版，不满意再给两三个其他思路，再不满意接着调 |
| **marx-paper-write** | 🚧 雏形完成 | 写正文：十种写作方法，复用间接引用时换说法 |
...
- 衔接：直接引用直接用、间接引用换说法用（write）；format 编排脚注参考文献，复用的不必再核实但告知用户
